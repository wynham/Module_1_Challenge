...
print(f"The total value of all loans combined is: {total_of_all_loans}")
...
# I extracted the loan cost below to compare it to the present value
...
present_value = present_value_calculator(
    future_value=new_loan.get("future_value"), remaining_months=new_loan.get("remaining_months"), annual_discount_rate=.2
)
print(f"The present value of the loan is: {present_value}")
